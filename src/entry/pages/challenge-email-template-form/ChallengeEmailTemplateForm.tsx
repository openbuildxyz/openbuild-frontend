...
import type { ChallengeEmailTemplateFormPageProps } from './typing';

function ChallengeEmailTemplateFormPage({ data }: ChallengeEmailTemplateFormPageProps) {
  const { base } = data || {};
...
export default ChallengeEmailTemplateFormPage;
